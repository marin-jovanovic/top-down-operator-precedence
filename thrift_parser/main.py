...
#             return ["Header",
#                     ["Include",
#                      ["\"include\"", "Literal", [self.value], "Identifier",
...
#     return string[re.match(regex, string).end():] if re.match(regex,
#                                                               string) else string
#
#
...
#         if not have_i_eaten:
#
#             if source_code.startswith(("*", "c_glib", "cpp", "delphi", "haxe",
#                                        "go", "java", "js", "lua",
#                                        "netstd", "perl", "php", "py.twisted",
#                                        "py", "rb", "st", "xsd")):
#
#                 t = ["*", "c_glib", "cpp", "delphi", "haxe", "go", "java", "js",
#                      "lua",
#                      "netstd", "perl", "php", "py.twisted", "py", "rb", "st",
#                      "xsd"]
#                 for elem in t:
#                     if source_code.startswith(elem):
#                         output.append(
#                             NamespaceScopeToken("NamespaceScope", row_number,
#                                                 elem))
...
#             elif source_code.startswith("{"):
#                 output.append(
#                     LeftCurlyBracketToken("left_curly_bracket", row_number,
#                                           "{"))
#                 source_code = source_code[1:]
#                 have_i_eaten = True
#
#             elif source_code.startswith("}"):
#                 output.append(
#                     RightCurlyBracketToken("right_curly_bracket", row_number,
#                                            "}"))
#                 source_code = source_code[1:]
#                 have_i_eaten = True
#
#             elif source_code.startswith("("):
#                 output.append(
#                     LeftRoundBracketToken("left_round_bracket", row_number,
#                                           "("))
#                 source_code = source_code[1:]
#                 have_i_eaten = True
#
#             elif source_code.startswith(")"):
#                 output.append(
#                     RightRoundBracketToken("right_round_bracket", row_number,
#                                            ")"))
#                 source_code = source_code[1:]
#                 have_i_eaten = True
#
#             elif source_code.startswith("["):
#                 output.append(
#                     LeftSquareBracketToken("left_square_bracket", row_number,
#                                            "["))
#                 source_code = source_code[1:]
#                 have_i_eaten = True
#
#             elif source_code.startswith("]"):
#                 output.append(
#                     RightSquareBracketToken("right_square_bracket", row_number,
#                                             "]"))
#                 source_code = source_code[1:]
#                 have_i_eaten = True
#
#             elif source_code.startswith("<"):
#                 output.append(
#                     LeftAngleBracketToken("left_angle_bracket", row_number,
#                                           "<"))
#                 source_code = source_code[1:]
#                 have_i_eaten = True
#
#             elif source_code.startswith(">"):
#                 output.append(
#                     RightAngleBracketToken("right_angle_bracket", row_number,
#                                            ">"))
#                 source_code = source_code[1:]
#                 have_i_eaten = True
#
...
#                  "binary", "slist")):
#
#                 t = ["bool", "byte", "i8", "i16", "i32", "i64", "double",
#                      "string", "binary", "slist"]
#                 for elem in t:
#                     if source_code.startswith(elem):
#                         output.append(
#                             BaseTypeToken("BaseType", row_number, elem))
#                         source_code = source_code[len(elem):]
#                         break
#
#                 have_i_eaten = True
...
#                     if source_code.startswith(elem):
#                         output.append(
#                             BaseTypeToken("ListSeparator", row_number, elem))
#                         source_code = source_code[len(elem):]
#                         break
#
...
#                     source_code = regex_cropper("\'[^\']*\'", source_code)
#
#                 elif re.match("([a-zA-Z]|_)([a-zA-Z]|[0-9]|\.|_)*",
#                               source_code):
#                     t = source_code[
#                         :re.match("([a-zA-Z]|_)([a-zA-Z]|[0-9]|\.|_)*",
#                                   source_code).end()]
#                     output.append(IdentifierToken("Identifier", row_number, t))
#                     source_code = regex_cropper(
#                         "([a-zA-Z]|_)([a-zA-Z]|[0-9]|\.|_)*", source_code)
#
#                 elif re.match("([a-zA-Z]|_)([a-zA-Z]|[0-9]|\.|_|-)*",
#                               source_code):
#                     t = source_code[
...
#                                   source_code).end()]
#                     output.append(
#                         STIdentifierToken("STIdentifier", row_number, t))
#                     source_code = regex_cropper(
#                         "([a-zA-Z]|_)([a-zA-Z]|[0-9]|\.|_|-)*", source_code)
#
...
#         return ['*', 'c_glib', 'cpp', 'delphi', 'haxe', 'go', 'java', 'js',
#                 'lua', 'netstd', 'perl',
