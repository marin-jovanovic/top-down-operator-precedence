...
class TestMain(unittest.TestCase):
    ...
    def test_27(self):
        ...
        self.assertEqual(output, ['if', 'a', 'then',
                                  ['if', 'b', 'then', 'c', 'else', 'd']])
    ...
    def test_31(self):
        output = self.execute(
            "\"if x + 1 == a + b then a + m + sin ( x ) else c + d\"")
        output = eval(output)
    ...
    def test_34(self):
        output = self.execute(
            "\"if x + 1 == a + b + sin ( x ) then a + b + ( a + d )\"")
        output = eval(output)

        self.assertEqual(output, ['if', ['==', ['+', 'x', '1'],
                                         ['+', ['+', 'a', 'b'],
                                          ['sin', '(', 'x', ')']]], 'then',
                                  ['+', ['+', 'a', 'b'],
                                   ['(', ['+', 'a', 'd'], ')']]])
