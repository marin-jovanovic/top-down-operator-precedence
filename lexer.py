...
OUTPUT = list()
LINE_NUMBER = 1
OP_NEW_LINE = "NOVI_REDAK"
OP_ENTER_STATE = "UDJI_U_STANJE"
OP_RET = "VRATI_SE"
NO_OP = "-"


def f_0(may_i_eat=False):
    global MAX_EATER_NUMBER, MAX_EATER_POINTER, SOURCE_CODE, CURRENT_STATE, OUTPUT, OP_NEW_
    global OP_RET, OP_ENTER_STATE, OP_NEW_LINE, LINE_NUMBER, NO_OP
...
def f_2(may_i_eat=False):
    ...
    if CURRENT_STATE == "S_pocetno":
        ...
        if may_i_eat:
            actions = ['-', 'UDJI_U_STANJE S_komentar']
...
def f_3(may_i_eat=False):
    ...
    if CURRENT_STATE == "S_komentar":
        ...
        if may_i_eat:
            actions = ['-', 'UDJI_U_STANJE S_pocetno']
...
def f_10(may_i_eat=False):
    ...
    if CURRENT_STATE == "S_pocetno":
        ...
        if may_i_eat:
            actions = ['OP_MINUS', 'UDJI_U_STANJE S_unarni', 'VRATI_SE 1']
            # ['OP_MINUS', 'UDJI_U_STANJE S_unarni', 'VRATI_SE 1']
...
def f_11(may_i_eat=False):
    ...
    if CURRENT_STATE == "S_pocetno":
        ...
        if may_i_eat:
            actions = ['LIJEVA_ZAGRADA', 'UDJI_U_STANJE S_unarni', 'VRATI_SE 1']
            # ['LIJEVA_ZAGRADA', 'UDJI_U_STANJE S_unarni', 'VRATI_SE 1']
...
def f_14(may_i_eat=False):
    ...
    if CURRENT_STATE == "S_unarni":
        ...
        if may_i_eat:
            actions = ['UMINUS', 'UDJI_U_STANJE S_pocetno']
            # ['UMINUS', 'UDJI_U_STANJE S_pocetno']
